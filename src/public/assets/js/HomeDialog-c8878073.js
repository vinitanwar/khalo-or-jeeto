...
import { O as _, y as p, C as w, a0 as y, V as d, Y as o, ab as n, R as S, P as r, a1 as k, T as u, _ as l, Z as C } from "./vendor-b2024301.js"
   ...
   x = _({
      ...
      setup(t, { emit: i }) {
         ...
         w(
            () => s.show,
            e => {
               e ? window.addEventListener("touchmove", c, { passive: !1 }) : window.removeEventListener("touchmove", c)
            },
         )
         function m(e) {
         ...
         return (e, a) => {
            ...
            return (
               ...
               d(
                  ...
                  [
                     o("div", B, [
                        o("div", D, [n(e.$slots, "header", {}, () => [k(o("img", $, null, 512), [[v, u(g)(t.pathname, t.picname)]])], !0)]),
                        o("div", O, [n(e.$slots, "title", {}, () => [o("h1", null, l(u(f)(t.title)), 1)], !0)]),
