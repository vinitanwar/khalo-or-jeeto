import { O as a, v as r, P as n, V as s, Y as c, a2 as i } from "./vendor-b2024301.js"
...
const l = { "aria-hidden": "true" },
   ...
   d = a({
      ...
      setup(e) {
         const t = e,
            o = r(() => `#${t.prefix}-${t.name}`)
         return (f, u) => (n(), s("span", { class: "cms-icon", style: i({ fontSize: e.size }) }, [(n(), s("svg", l, [c("use", { href: o.value, fill: e.color }, null, 8, p)]))], 4))
      },
   })
